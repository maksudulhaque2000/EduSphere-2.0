  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-teal-100 via-teal-200 to-teal-300">
      ...
      <div className="w-full max-w-3xl p-8 bg-white rounded-lg shadow-xl">
        <h3 className="text-4xl font-bold mb-6 text-center text-teal-600">
          Add Class
        </h3>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="text-center">
            <button
              type="submit"
              className="inline-flex items-center justify-center w-full px-6 py-3 text-lg font-medium text-white bg-teal-600 rounded-md shadow-md hover:bg-teal-800 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
            >
